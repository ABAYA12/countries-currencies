...
while True:
    try:
        country_name = str(input("Enter a country to see its currency: "))
        if country_name in countries:
            print(f"{country_name} : {countries[country_name]}")
            break
    except NameError:
        print("Name check country name again and spell it correctly")
